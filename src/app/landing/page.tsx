      ...
      <section className="relative overflow-hidden py-12 px-4">
        <div className="relative max-w-lg mx-auto text-center">
          ...
          {!isInstalled && deferredPrompt ? (
            <button
              onClick={installApp}
              className={`w-full py-4 ${t.buttonBg} text-white rounded-xl font-bold text-lg shadow-lg active:scale-[0.98] transition-all flex items-center justify-center gap-2 mb-3`}
            >
          ...
          <a
            href="/"
            className={`inline-block px-6 py-3 ${t.buttonBg} text-white rounded-xl font-bold text-base shadow-lg active:scale-[0.98] transition-all ${!isInstalled && deferredPrompt ? 'opacity-80' : ''}`}
          >
            {isInstalled ? "Open Bible App" : "Start Reading"}
          </a>
        </div>
      </section>
