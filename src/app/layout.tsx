            ...
            __html: `
              (function() {
                try {
                  ...
                  var themeData = {
                    'light': { color: '#ffffff', text: '#111827' },
                    'warm': { color: '#faf6f0', text: '#3d3222' },
                    'dark': { color: '#1a1a2e', text: '#e5e7eb' },
                    'midnight': { color: '#030712', text: '#f3f4f6' },
                    'amoled': { color: '#000000', text: '#f3f4f6' },
                    'ocean': { color: '#0a192f', text: '#f0f9ff' }
                  };
